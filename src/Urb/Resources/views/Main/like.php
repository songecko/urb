<div id="contenedor" class="no-like">
	<img src="<?php echo $view['assets']->getUrl('images/urb.png')?>" width="150" style="padding: 15px" />
	<div class="megusta" style="color: #fff; background: rgba(224,1,9,1);">
		<div class="arrow-up" style="border-bottom-color: #e00109;"></div>
		<p>HACÉ CLICK EN<br><strong>“ME GUSTA”</strong> Y PARTICIPÁ</p>
	</div>
	<div class="info">
		...
		<p>Encontrá tu look eligiendo alguna de<br>las fotos de tus álbumes de Facebook.<br></p>
	</div>
